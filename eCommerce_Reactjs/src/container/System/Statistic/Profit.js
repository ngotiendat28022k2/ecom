    ...
    <div className="container-fluid px-4">
      ...
      <div className="card mb-4">
        ...
        <div className="card-body">
                  ...
                  dataOrder.map((item, index) => {
                    return (
                      <tr key={index}>
                        ...
                        <td>
                          {CommonUtils.formatter.format(item.totalpriceProduct)}
                        </td>
                        <td>
                          {CommonUtils.formatter.format(item.importPrice)}
                        </td>
                        <td>
                          {CommonUtils.formatter.format(item.profitPrice)}
                        </td>
                        <td>
          ...
          <span
            style={{ color: "#df1b21", fontSize: "26px" }}
